...
ActiveRecord::Schema[7.2].define(version: 2025_01_28_142120) do
  ...
  create_table "authors_books_joint_tables", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_authors_books_joint_tables_on_author_id"
  ...
  add_foreign_key "authors_books_joint_tables", "authors"
  add_foreign_key "authors_books_joint_tables", "books"
